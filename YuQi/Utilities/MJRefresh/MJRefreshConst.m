...
NSString *const MJRefreshFooterReleaseToRefresh = @"松开";
NSString *const MJRefreshFooterRefreshing = @"兮八加载中...";

NSString *const MJRefreshHeaderPullToRefresh = @"下拉刷新";
NSString *const MJRefreshHeaderReleaseToRefresh = @"松开";
NSString *const MJRefreshHeaderRefreshing = @"兮八加载中...";
